...
export default function AdminPage() {
  ...
  const weddingForm = useForm<WeddingFormValues>({
    ...
    defaultValues: {
      ...
      tvVideoType: "youtube",
      musicUrl: "https://youtu.be/WyrZYGmoaFM",
      musicType: "youtube",
      clientUsername: "",
      clientPassword: "",
      allowedColors: "[]",
  ...
  function openEditWedding(wedding: Wedding) {
    ...
    weddingForm.reset({
      ...
      tvVideoUrl: wedding.tvVideoUrl || "https://youtu.be/BboMpayJomw?t=25",
      tvVideoType: wedding.tvVideoType || "youtube",
      musicUrl: wedding.musicUrl || "https://youtu.be/WyrZYGmoaFM",
      musicType: wedding.musicType || "youtube",
