...
export const weddings = sqliteTable("weddings", {
  ...
  couplePhotoPosition: text("couple_photo_position").default("center"),
  venueImageUrl: text("venue_image_url").default(""),
  venueMapUrl: text("venue_map_url").default(""),
  churchImageUrl: text("church_image_url").default(""),
  churchMapUrl: text("church_map_url").default(""),
  showReception: integer("show_reception").notNull().default(1),
  ceremonyTitle: text("ceremony_title").default("Ceremonia Religiosa"),
